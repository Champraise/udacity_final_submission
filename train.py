...
model, criterion, optimizer = lib.build_model(arch, hidden_units, learning_rate, dropout, device)
lib.train_model(model, criterion, optimizer, trainloader, validloader, testloader, epochs, device, 20)
lib.save_checkpoint(arch, epochs, hidden_units, learning_rate, model, optimizer, train_datasets, save_dir)
